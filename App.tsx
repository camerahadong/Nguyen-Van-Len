...
>
<channel>
	<title>Thanh Hà Runner Export</title>
	<pubDate>${new Date().toUTCString()}</pubDate>
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-20 shadow-sm/50 backdrop-blur-md bg-white/90">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-bold text-slate-800 tracking-tight hidden md:block">Thanh Hà Runner Wizard</h1>
          </div>
                       ...
                       <div className="w-full md:w-1/4">
                         <div className="relative h-full">
                           <input
                             ...
                             placeholder="Category (e.g. Hướng dẫn người mới)"
